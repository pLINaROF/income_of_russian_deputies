...
* 5_pdf_auto_parser.py - попытка прикрутить к предыдущему пункту tabula. Результат парсинга 7 созыва после правки 4 записей совпадает с результатом ручного парсинга, но сделано криво.
